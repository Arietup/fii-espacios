    ...
    <AdminModal title="Nueva planta" backHref="/admin/plantas" backLabel="Plantas" size="xl">
      <form action={createPlanta} className="grid gap-5 sm:grid-cols-2">
          <label className="space-y-1">
            ...
            <select name="bloqueId" required className="h-10 w-full rounded-lg border border-[var(--border-soft)] px-3 text-sm">
          ...
          <label className="space-y-1">
            ...
            <input name="codigo" className="h-10 w-full rounded-lg border border-[var(--border-soft)] px-3 text-sm" />
          </label>
          <label className="space-y-1">
            <span className="text-sm font-medium text-[var(--text)]">Nivel</span>
            <input name="nivel" type="number" defaultValue="0" className="h-10 w-full rounded-lg border border-[var(--border-soft)] px-3 text-sm" />
          </label>
          <label className="space-y-1 sm:col-span-2">
            <span className="text-sm font-medium text-[var(--text)]">Imagen / plano URL *</span>
            <input name="imagenUrl" required placeholder="/planos/bloque-a-b-c-planta-baja.svg" className="h-10 w-full rounded-lg border border-[var(--border-soft)] px-3 text-sm" />
          </label>
          <label className="space-y-1 sm:col-span-2">
          ...
          <label className="space-y-1 sm:col-span-2">
            ...
            <textarea name="observaciones" rows={2} className="w-full rounded-lg border border-[var(--border-soft)] px-3 py-2 text-sm" />
          </label>
